...
-(void)loadView{
    ...
    _alertMessageLabel.frame = CGRectMake((CGRectGetWidth(self.view.frame)-alertMessageWidth)/2, CGRectGetMaxY(_alertTitleLabel.frame), alertMessageWidth, [_alertMessageLabel sizeThatFits:CGSizeMake(alertMessageWidth, CGFLOAT_MAX)].height+30);
