...
- (void)viewDidLoad {
    ...
    UIButton * deleteBtn = [[UIButton alloc]initWithFrame:CGRectMake(CGRectGetWidth(_titleView.frame)-CGRectGetHeight(backBtn.frame), CGRectGetMinY(backBtn.frame), CGRectGetHeight(backBtn.frame), CGRectGetHeight(backBtn.frame))];
